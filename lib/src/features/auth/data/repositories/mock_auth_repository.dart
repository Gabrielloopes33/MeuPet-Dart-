...
class MockAuthRepository implements AuthRepositoryInterface {
  ...
  Future<User?> login(String phone, String password) async {
    ...
    try {
      ...
      // Simular token JWT
      final mockToken = 'mock_jwt_token_${userData['id']}_${DateTime.now().millisecondsSinceEpoch}';
      ...
      return User(
        ...
        createdAt: DateTime.now().subtract(const Duration(days: 30)), // Simular conta criada há 30 dias
  ...
  Future<User?> register(String name, String phone, String password) async {
    ...
    try {
      ...
      // Simular token JWT
      final mockToken = 'mock_jwt_token_${newUserId}_${DateTime.now().millisecondsSinceEpoch}';
